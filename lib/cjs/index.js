...
class CameraPermission {
                    ...
                    : /macintosh|mac os x/.test(userAgent)
                        ...
                        : /windows|win32/.test(userAgent)
                            ...
                            : /linux/.test(userAgent)
                                ? 'linux'
                                : 'unknown';
            let details = (this.permissions_data || constants_1.permission_details)[browser][os];
            const message = (this.errors_data || constants_1.error_messages)[error_name] || constants_1.error_messages.Default;
            const isMobile = (os === 'android' || os === 'ios');
            if (error_name === 'System Error') {
                details = (this.permissions_data || constants_1.permission_details).system[os];
            }
    ...
    handlePermissionDenied(error) {
        ...
        return {
            ...
            showSteps: () => __awaiter(this, void 0, void 0, function* () { return (0, modal_1.default)({ steps, message, screenshot_urls }); }),
        };
    }
}
